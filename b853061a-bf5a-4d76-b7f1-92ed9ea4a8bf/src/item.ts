...
export default class Button implements IScript<Props> {
  ...
  setEnabled(host: Entity, ent: Entity, enabled: boolean) {
    if (enabled) {
      ...
      ent.addComponentOrReplace(new GLTFShape('b853061a-bf5a-4d76-b7f1-92ed9ea4a8bf/models/Collider.glb'))
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    const shape = new GLTFShape('b853061a-bf5a-4d76-b7f1-92ed9ea4a8bf/models/Collider.glb')
